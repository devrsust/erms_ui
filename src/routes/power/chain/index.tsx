...
import { ArrowUpDown, Plus, MoreVertical, Copy, Eye, Edit, Trash2, User, Shield, Link2, GripVertical, Unlink } from 'lucide-react'
...
export const Route = createFileRoute('/power/chain/')({
